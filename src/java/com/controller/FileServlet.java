...
public class FileServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        // Get upload path (path to get all resources from) as init parameter.
        this.uploadPath = getServletContext().getInitParameter("uploadPath");

        // Validate upload path.
        if (this.uploadPath == null) {
            throw new ServletException("FileServlet init param 'uploadPath' is required.");
        } else {
            File path = new File(this.uploadPath);
            if (!path.exists()) {
                throw new ServletException("FileServlet init param 'uploadPath' value '"
                    + this.uploadPath + "' does actually not exist in file system.");
            ...
            throws IOException
    {
        ...
        File file = new File(uploadPath, URLDecoder.decode(requestedFile, "UTF-8"));
